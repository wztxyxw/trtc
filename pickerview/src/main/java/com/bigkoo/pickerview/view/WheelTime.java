...
public class WheelTime {
    ...
    public WheelTime(View view, boolean[] type, int gravity, int textSize, int second) {
        super();
        this.view = view;
        this.type = type;
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        ...
        wv_minutes.setAdapter(new NumericWheelAdapter(0, 5, second));
        //wv_minutes.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
        wv_minutes.setCurrentItem(m/second);
        ...
        wv_seconds.setCurrentItem(s/second);
           ...
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        ...
                        .append(wv_minutes.getCurrentItem() * second).append(":")
