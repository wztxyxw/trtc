...
//        final int subHeight    = Utils.dip2px(context, 180);
        final int subWidth     = Utils.dip2px(context, 180);
        final int subHeight    = Utils.dip2px(context, 120);
...
//            layoutParams.topMargin = layoutHeight - (bottomMargin + midMargin * (i + 1) + subHeight * i) - subHeight;
            ...
            layoutParams.topMargin = layoutHeight  - subHeight;
...
//            layoutParams.topMargin = layoutHeight - (bottomMargin + midMargin * (i + 1) + subHeight * i) - subHeight;
     ...
     * @return
     */
    public static ArrayList<RelativeLayout.LayoutParams> initGrid4Param(Context context, int top, int layoutWidth, int layoutHeight) {
...
//        layoutParams3.rightMargin = margin;
     ...
     * @return
     */
    public static ArrayList<RelativeLayout.LayoutParams> initGrid9Param(Context context, int top, int layoutWidth, int layoutHeight) {
//        int margin       = dip2px(context, 10);
        int bottomMargin = dip2px(context, 50);
        int margin = top;
