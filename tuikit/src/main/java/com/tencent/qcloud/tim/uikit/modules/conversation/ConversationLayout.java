...
public class ConversationLayout extends RelativeLayout implements IConversationLayout {
    ...
    public void removeConversationInfo(ConversationInfo conversation) {
        ConversationManagerKit.getInstance().deleteConversation(conversation.getId(), conversation.isGroup());
    }

//    public void removeConversation(String userId) {
//        ConversationManagerKit.getInstance().removeConversation(userId);
//    }
//
//    public void addConversation(String userId) {
//        ConversationManagerKit.getInstance().addConversation(userId);
//    }
//
//    public void setDeleteDataSource(List<String> deleteDataSource) {
//        ConversationManagerKit.getInstance().setDeleteDataSource(deleteDataSource);
//    }
