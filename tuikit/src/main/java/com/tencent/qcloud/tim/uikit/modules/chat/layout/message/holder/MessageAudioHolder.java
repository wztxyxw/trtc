...
public class MessageAudioHolder extends MessageContentHolder {
    ...
    public void layoutVariableViews(final MessageInfo msg, final int position) {
        ...
        if (msg.isSelf()) {
            ...
            audioPlayImage.setImageResource(R.drawable.ic_voice_msg_playing_mi_3);
            ...
            // TODO 图标不对
            audioPlayImage.setImageResource(R.drawable.ic_voice_msg_playing_3);
            audioContentView.removeView(audioPlayImage);
        ...
        msgContentFrame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.isSelf()) {
                    audioPlayImage.setImageResource(R.drawable.play_voice_message_mi);
                } else {
                    audioPlayImage.setImageResource(R.drawable.play_voice_message_other);
                }
                if (msg.isSelf()) {
                    audioPlayImage.setRotation(180f);
                }
