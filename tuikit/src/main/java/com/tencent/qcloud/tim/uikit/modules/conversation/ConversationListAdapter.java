...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    private ConversationListLayout.OnItemHeaderClickListener mOnItemHeaderClickListener;
    ...
    public void setOnItemHeaderClickListener(ConversationListLayout.OnItemHeaderClickListener listener) {
        this.mOnItemHeaderClickListener = listener;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            default:
                ...
                if (mOnItemHeaderClickListener != null) {

                    ((ConversationCommonHolder) holder).conversationIconView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            mOnItemHeaderClickListener.onItemHeaderClick(v, position, conversationInfo);
                        }
                    });
                }
