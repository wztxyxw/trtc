 ...
 */
public class PhotosAdapter2 extends RecyclerView.Adapter {
    ...
    public PhotosAdapter2(Context cxt, ArrayList<Object> dataList, OnClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
//            case TYPE_AD:
//                return new AdViewHolder(mInflater.inflate(R.layout.item_ad_easy_photos2, parent, false));
            case TYPE_CAMERA:
                return new CameraViewHolder(mInflater.inflate(R.layout.item_camera_easy_photos2, parent, false));
            default:
                return new PhotoViewHolder(mInflater.inflate(R.layout.item_rv_photos_easy_photos2, parent, false));
        }
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof PhotoViewHolder) {
            ...
            updateSelector(((PhotoViewHolder) holder).ivSelector, item.selected, item, p);
            ...
            ((PhotoViewHolder) holder).ivSelector.setVisibility(View.VISIBLE);
...
//                        ((PhotoViewHolder) holder).tvSelector.setText(String.valueOf(Result.count()));
                        ...
                        ((PhotoViewHolder) holder).ivSelector.setSelected(true);
    ...
    private void updateSelector(ImageView ivSelector, boolean selected, Photo photo, int position) {
        if (selected) {
...
//                tvSelector.setBackgroundResource(R.drawable.bg_select_false_easy_photos);
    ...
    public class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        PhotoViewHolder(View itemView) {
            ...
            this.ivSelector = itemView.findViewById(R.id.iv_selector);
