...
//        }).start();
    ...
    private void shouldShowMenuDone() {
        ...
        if (Setting.allType) {
            ...
            if (Setting.selectType.contains(Type.VIDEO)) {
                tvDone.setText(getString(R.string.selector_action_done_easy_photos, Result.count(),
                        Setting.videoCount));
            } else {
                tvDone.setText(getString(R.string.selector_action_done_easy_photos, Result.count(),
                        Setting.pictureCount));
            }
        }
    }
    ...
    public void onSelectorOutOfMax(@Nullable Integer result) {
        ...
        switch (result) {
            ...
            case -2:
                ...
                break;
            case -3:
                Toast.makeText(this, getString(R.string.selector_reach_video_or_photos), Toast.LENGTH_SHORT).show();
                break;
        }
    }
