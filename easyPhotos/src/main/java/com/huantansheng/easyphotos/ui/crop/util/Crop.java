package com.huantansheng.easyphotos.ui.crop.util;
...
import com.huantansheng.easyphotos.ui.CropImageActivity;
...
public class Crop {
    ...
    public static Crop of(int type, Uri source, Uri destination) {
        return new Crop(type, source, destination);
    }
    ...
    private Crop(int type, Uri source, Uri destination) {
        cropIntent = new Intent();
        cropIntent.setData(source);
        cropIntent.putExtra(MediaStore.EXTRA_OUTPUT, destination);
